    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.messageId) {
            this.$http({
              url: this.$http.adornUrl(`/mall_order/mqmessage/info/${this.dataForm.messageId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/mall_order/mqmessage/${!this.dataForm.messageId ? 'save' : 'update'}`),
              method: 'post',
